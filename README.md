...
You can find more information, about the datasheets and schematic and boardview files (i recommend to use FlexBV5 to open the TVW file), in the open-source provider cloud file repository in this link: ... 
