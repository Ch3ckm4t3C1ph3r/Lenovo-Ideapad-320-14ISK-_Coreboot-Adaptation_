...
> [!NOTE]
> Unfortunately the CBFS needs not only have the Coreboot code because the Intel ME is necesarily to turn on the RAM memory, not public data available to doing this, to use it in RAM stage.
