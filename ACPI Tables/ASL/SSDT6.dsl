...
Buffer (One)
 ...
 (One)
    ...
    0178: 41 44 20 46 3A 31 00                             // AD F:1.
                                ...
                                {
                                    Store (DerefOf (
    017F: A0 49 07 93 45 49 41 50 00 70 83                 // .I..EIAP.p.

Index (Arg3, Zero)), PECE) /* \EIAD._DSM.PECE */
                                    Store (DerefOf (
    018A: 88 6B 00 00 50 45 43 45 70 83                    // .k..PECEp.

Index (Arg3, One)), PECD) /* \EIAD._DSM.PECD */
 ...
 (0x02)
    ...
    020E: 49 41 44 20 46 3A 32 00 70 83                    // IAD F:2.p.

Index (Arg3, Zero)), DFUE) /* \EIAD._DSM.DFUE */
                                Store (DerefOf (
    0218: 88 6B 00 00 44 46 55 45 70 83                    // .k..DFUEp.

Index (Arg3, One)), DFUD) /* \EIAD._DSM.DFUD */
...
/*
Raw Table Data: Length 838 (0x346)

    0000: 53 53 44 54 46 03 00 00 01 B0 4C 45 4E 4F 56 4F  // SSDTF.....LENOVO
    0010: 43 42 2D 30 31 20 20 20 01 00 00 00 41 43 50 49  // CB-01   ....ACPI
    0020: 00 00 04 00 A0 43 07 00 15 5C 41 44 42 47 08 01  // .....C...\ADBG..
    0030: 15 5C 45 49 41 50 00 00 15 5C 45 49 44 46 01 00  // .\EIAP...\EIDF..
    0040: 15 5C 2E 5F 53 42 5F 47 47 4F 56 08 01 15 5C 2E  // .\._SB_GGOV...\.
    0050: 5F 53 42 5F 53 47 4F 56 08 02 15 5C 2F 03 5F 53  // _SB_SGOV...\/._S
    0060: 42 5F 50 43 49 30 47 45 58 50 06 00 15 5C 2F 04  // B_PCI0GEXP...\/.
    0070: 5F 53 42 5F 50 43 49 30 47 45 58 50 53 47 45 50  // _SB_PCI0GEXPSGEP
    0080: 08 03 15 5C 2F 04 5F 53 42 5F 50 43 49 30 47 45  // ...\/._SB_PCI0GE
    0090: 58 50 47 45 50 53 08 02 10 4D 2A 5C 00 5B 82 47  // XPGEPS...M*\.[.G
    00A0: 2A 45 49 41 44 08 5F 48 49 44 0C 25 D4 33 99 08  // *EIAD._HID.%.3..
    00B0: 5F 53 30 57 00 14 2E 5F 53 54 41 08 41 44 42 47  // _S0W..._STA.ADBG
    00C0: 0D 45 49 41 44 20 53 54 41 00 A0 0A 93 45 49 41  // .EIAD STA....EIA
    00D0: 50 01 A4 0A 0F A1 0C A0 0A 93 45 49 44 46 01 A4  // P.........EIDF..
    00E0: 0A 0F A4 00 14 41 26 5F 44 53 4D 0C 08 5F 54 5F  // .....A&_DSM.._T_
    00F0: 30 00 08 50 45 43 45 00 08 50 45 43 44 00 08 44  // 0..PECE..PECD..D
    0100: 46 55 45 00 08 44 46 55 44 00 08 4F 4C 44 56 00  // FUE..DFUD..OLDV.
    0110: 08 50 45 43 56 00 08 44 46 55 56 00 A0 44 22 93  // .PECV..DFUV..D".
    0120: 68 11 13 0A 10 1F 3C F0 AD 76 EE 23 4F 9D EF CD  // h.....<..v.#O...
    0130: AE 22 A3 6A CF A0 49 20 92 95 99 69 00 01 A2 4E  // .".j..I ...i...N
    0140: 1F 01 70 99 6A 00 5F 54 5F 30 A0 1A 93 5F 54 5F  // ..p.j._T_0..._T_
    0150: 30 00 41 44 42 47 0D 45 49 41 44 20 46 3A 30 00  // 0.ADBG.EIAD F:0.
    0160: A4 11 03 01 0F A1 46 1D A0 42 09 93 5F 54 5F 30  // ......F..B.._T_0
    0170: 01 41 44 42 47 0D 45 49 41 44 20 46 3A 31 00 A0  // .ADBG.EIAD F:1..
    0180: 49 07 93 45 49 41 50 00 70 83 88 6B 00 00 50 45  // I..EIAP.p..k..PE
    0190: 43 45 70 83 88 6B 01 00 50 45 43 44 70 5C 2F 04  // CEp..k..PECDp\/.
    01A0: 5F 53 42 5F 50 43 49 30 47 45 58 50 47 45 50 53  // _SB_PCI0GEXPGEPS
    01B0: 00 0A 0C 4F 4C 44 56 5C 2F 04 5F 53 42 5F 50 43  // ...OLDV\/._SB_PC
    01C0: 49 30 47 45 58 50 53 47 45 50 00 0A 0C 50 45 43  // I0GEXPSGEP...PEC
    01D0: 45 A0 27 94 50 45 43 44 00 5B 22 50 45 43 44 5C  // E.'.PECD.["PECD\
    01E0: 2F 04 5F 53 42 5F 50 43 49 30 47 45 58 50 53 47  // /._SB_PCI0GEXPSG
    01F0: 45 50 00 0A 0C 4F 4C 44 56 A4 00 A1 40 14 A0 43  // EP...OLDV...@..C
    0200: 0C 93 5F 54 5F 30 0A 02 41 44 42 47 0D 45 49 41  // .._T_0..ADBG.EIA
    0210: 44 20 46 3A 32 00 70 83 88 6B 00 00 44 46 55 45  // D F:2.p..k..DFUE
    0220: 70 83 88 6B 01 00 44 46 55 44 A0 2E 93 45 49 41  // p..k..DFUD...EIA
    0230: 50 01 70 5C 2E 5F 53 42 5F 47 47 4F 56 0C 15 00  // P.p\._SB_GGOV...
    0240: 00 02 4F 4C 44 56 5C 2E 5F 53 42 5F 53 47 4F 56  // ..OLDV\._SB_SGOV
    0250: 0C 15 00 00 02 44 46 55 45 A1 28 70 5C 2E 5F 53  // .....DFUE.(p\._S
    0260: 42 5F 47 47 4F 56 0C 03 00 04 02 4F 4C 44 56 5C  // B_GGOV.....OLDV\
    0270: 2E 5F 53 42 5F 53 47 4F 56 0C 03 00 04 02 44 46  // ._SB_SGOV.....DF
    0280: 55 45 A0 3D 94 44 46 55 44 00 5B 22 44 46 55 44  // UE.=.DFUD.["DFUD
    0290: A0 1A 93 45 49 41 50 01 5C 2E 5F 53 42 5F 53 47  // ...EIAP.\._SB_SG
    02A0: 4F 56 0C 15 00 00 02 4F 4C 44 56 A1 14 5C 2E 5F  // OV.....OLDV..\._
    02B0: 53 42 5F 53 47 4F 56 0C 03 00 04 02 4F 4C 44 56  // SB_SGOV.....OLDV
    02C0: A4 00 A1 49 07 A0 46 07 93 5F 54 5F 30 0A 03 41  // ...I..F.._T_0..A
    02D0: 44 42 47 0D 45 49 41 44 20 46 3A 33 00 A0 21 93  // DBG.EIAD F:3..!.
    02E0: 45 49 41 50 01 70 5C 2E 5F 53 42 5F 47 47 4F 56  // EIAP.p\._SB_GGOV
    02F0: 0C 15 00 00 02 44 46 55 56 70 01 50 45 43 56 A1  // .....DFUVp.PECV.
    0300: 30 70 5C 2E 5F 53 42 5F 47 47 4F 56 0C 03 00 04  // 0p\._SB_GGOV....
    0310: 02 44 46 55 56 70 5C 2F 04 5F 53 42 5F 50 43 49  // .DFUVp\/._SB_PCI
    0320: 30 47 45 58 50 47 45 50 53 00 0A 0C 50 45 43 56  // 0GEXPGEPS...PECV
    0330: A4 12 0A 02 50 45 43 56 44 46 55 56 A5 A4 00 A4  // ....PECVDFUV....
    0340: 00 A4 11 03 01 00                                // ......
 */
